  ...
  return (
    <div className="relative min-h-screen bg-bg overflow-hidden">
      ...
      <div className="fixed inset-0 w-full h-full z-0">
        ...
        <div 
          className="absolute left-2 sm:left-4 md:left-6 lg:left-8 top-[35%] transform -translate-y-1/2 z-20 cursor-pointer group" 
        ...
        >
          <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-black/40 rounded-full flex items-center justify-center backdrop-blur-md border border-white/30 hover:bg-black/60 active:scale-95 transition-all duration-200 shadow-lg hover:shadow-2xl hover:shadow-black/50">
            {isMuted ? (
