  ...
  return (
    <div className="relative min-h-screen bg-bg overflow-hidden">
      ...
      <div className="fixed inset-0 w-full h-full z-0">
        ...
        >
          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-sm border border-white/20 hover:bg-white/20 hover:shadow-lg hover:shadow-black/50 transition-all duration-200">
            {isMuted ? (
